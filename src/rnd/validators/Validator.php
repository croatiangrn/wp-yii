...
class Validator extends Component
{
	...
	public static $builtInValidators = [
		'boolean' => 'rnd\validators\BooleanValidator',
		'captcha' => 'rnd\captcha\CaptchaValidator',
		...
		'default' => 'rnd\validators\DefaultValueValidator',
		'double' => 'rnd\validators\NumberValidator',
		'each' => 'rnd\validators\EachValidator',
		'email' => 'rnd\validators\EmailValidator',
		'exist' => 'rnd\validators\ExistValidator',
		'file' => 'rnd\validators\FileValidator',
		'filter' => 'rnd\validators\FilterValidator',
		'image' => 'rnd\validators\ImageValidator',
		'in' => 'rnd\validators\RangeValidator',
		'integer' => [
			'class' => 'rnd\validators\NumberValidator',
			'integerOnly' => true,
		],
		'match' => 'rnd\validators\RegularExpressionValidator',
		'number' => 'rnd\validators\NumberValidator',
		'required' => 'rnd\validators\RequiredValidator',
		'safe' => 'rnd\validators\SafeValidator',
		'string' => 'rnd\validators\StringValidator',
		'trim' => [
			'class' => 'rnd\validators\FilterValidator',
			'filter' => 'trim',
			'skipOnArray' => true,
		],
		'unique' => 'rnd\validators\UniqueValidator',
		'url' => 'rnd\validators\UrlValidator',
		'ip' => 'rnd\validators\IpValidator',
	];
	/**
	 ...
	 * @param \rnd\base\BaseModel $model      the data model to be validated.
	 * @param array|string        $attributes list of attributes to be validated. This can be either an array of
	 *                                        the attribute names or a string of comma-separated attribute names.
	 * @param array               $params     initial values to be applied to the validator properties.
	 *
	 * @return object Validator the validator
	...
	public static function createValidator($type, $model, $attributes, $params = [])
	{
		...
		return Rnd::createObject($params);
	}
	 ...
	 *                                        Note that if an attribute is not associated with the validator - it will
	 *                                        be ignored. If this parameter is null, every attribute listed in
	...
	public function validate($value, &$error = null)
	{
		...
		$params['attribute'] = Rnd::t('the input value', 'yii');
		if (is_array($value)) {
			$params['value'] = 'array()';
	 ...
	 * @see \rnd\widgets\ActiveForm::enableClientValidation
	 */
	 ...
	 * @param \rnd\base\BaseModel $model the model being validated
	...
	{
		if (Rnd::$app !== null) {
			return \Rnd::$app->getI18n()->format($message, $params, Rnd::$app->language);
		}
