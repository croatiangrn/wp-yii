...
class CompareValidator extends Validator
{
	...
	public function init()
	{
		...
		if ($this->message === null) {
			switch ($this->operator) {
				case '==':
					$this->message = Rnd::t( '{attribute} must be equal to "{compareValueOrAttribute}".', 'rnd');
					break;
				case '===':
					$this->message = Rnd::t( '{attribute} must be equal to "{compareValueOrAttribute}".', 'rnd');
					break;
				case '!=':
					$this->message = Rnd::t( '{attribute} must not be equal to "{compareValueOrAttribute}".', 'rnd');
					break;
				case '!==':
					$this->message = Rnd::t( '{attribute} must not be equal to "{compareValueOrAttribute}".', 'rnd');
					break;
				case '>':
					$this->message = Rnd::t( '{attribute} must be greater than "{compareValueOrAttribute}".', 'rnd');
					break;
				case '>=':
					$this->message = Rnd::t( '{attribute} must be greater than or equal to "{compareValueOrAttribute}".', 'rnd');
					break;
				case '<':
					$this->message = Rnd::t( '{attribute} must be less than "{compareValueOrAttribute}".', 'rnd');
					break;
				case '<=':
					$this->message = Rnd::t( '{attribute} must be less than or equal to "{compareValueOrAttribute}".', 'rnd');
					break;
				default:
	...
	public function validateAttribute($model, $attribute)
	{
		...
		if (is_array($value)) {
			$this->addError($model, $attribute, Rnd::t( '{attribute} is invalid.'));
