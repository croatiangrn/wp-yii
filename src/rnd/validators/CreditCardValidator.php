...
class CreditCardValidator extends Validator
{
	...
	public function init()
	{
		if ($this->message === null) {
			$this->message = Rnd::t('{attribute} is not a valid Credit Card number.');
		}
		if ($this->messageFormat === null) {
			$this->messageFormat = Rnd::t('The "format" property must be specified with a supported Credit Card format.');
		}
	}
