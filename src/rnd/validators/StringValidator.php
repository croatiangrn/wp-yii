...
class StringValidator extends Validator
{
	...
	public function init()
	{
		...
		if ($this->encoding === null) {
			$this->encoding = Rnd::$app ? Rnd::$app->charset : 'UTF-8';
		}
		if ($this->message === null) {
			$this->message = Rnd::t('{attribute} must be a string.', 'rnd');
		}
		if ($this->min !== null && $this->tooShort === null) {
			$this->tooShort = Rnd::t('{attribute} should contain at least {min, number} {min, plural, one{character} other{characters}}.', 'rnd');
		}
		if ($this->max !== null && $this->tooLong === null) {
			$this->tooLong = Rnd::t('{attribute} should contain at most {max, number} {max, plural, one{character} other{characters}}.', 'rnd');
		}
		if ($this->length !== null && $this->notEqual === null) {
			$this->notEqual = Rnd::t('{attribute} should contain {length, number} {length, plural, one{character} other{characters}}.', 'rnd');
		}
	}
