...
class PhpMessageSource extends MessageSource
{
	 ...
	 */
	public $basePath = '@themeroot/messages';
	/**
	...
	protected function loadMessages($category, $language)
	{
		...
		if ($language !== $fallbackLanguage) {
			...
			if ($messages === null) {
				print_r("The message file for category '$category' does not exist: $messageFile", __METHOD__);
			}
		}
	...
	protected function loadFallbackMessages($category, $fallbackLanguage, $messages, $originalMessageFile)
	{
		...
		if (
			...
			print_r("The message file for category '$category' does not exist: $originalMessageFile "
	...
	{
		$messageFile = Rnd::getAlias($this->basePath) . "/$language/";
