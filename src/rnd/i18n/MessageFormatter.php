...
class MessageFormatter extends Component
{
	 ...
	 * @throws \rnd\base\NotSupportedException when PHP intl extension is not installed.
	 */
	...
	{
		$charset = Rnd::$app ? Rnd::$app->charset : 'UTF-8';
		$depth = 1;
	 ...
	 * @throws \rnd\base\NotSupportedException when unsupported formatting is used.
	 */
