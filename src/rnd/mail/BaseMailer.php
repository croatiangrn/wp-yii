...
use rnd\base\View;
use rnd\base\ViewContextInterface;
...
abstract class BaseMailer extends Component implements MailerInterface, ViewContextInterface
{
	...
	/**
	 * @var \rnd\base\View|array view instance or its array configuration.
	 */
	private $_view = [];
	/**
	...
	public function compose($view = null, array $params = [])
	{
		...
		if (isset($text)) {
			...
			$text = html_entity_decode(strip_tags($html), ENT_QUOTES | ENT_HTML5, Rnd::$app ? Rnd::$app->charset : 'UTF-8');
			// improve whitespace
	...
	public function send($message)
	{
		...
		Rnd::info('Sending email "' . $message->getSubject() . '" to "' . $address . '"', __METHOD__);
	...
	{
		$path = Rnd::getAlias($this->fileTransportPath);
		if (!is_dir($path)) {
