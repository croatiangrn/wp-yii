...
class ActiveField extends Component
{
	...
	public $form;
	/**
	 * @var BaseModel the data model that this field is associated with.
	 */
	public $model;
	/**
	 ...
	 *   See also [[\rnd\helpers\Html::tag()]].
	 *
	 * If you set a custom `id` for the container element, you may need to adjust the [[$selectors]] accordingly.
	 *
	 * @see \rnd\helpers\Html::renderTagAttributes() for details on how attributes are being rendered.
	 */
	 ...
	 * use [[\rnd\helpers\Html::activeHiddenInput()]].
	 *
	 * This method will generate the `name` and `value` tag attributes automatically for the model attribute
	 * unless they are explicitly specified in `$options`.
	 * @param array $options the tag options in terms of name-value pairs. These will be rendered as
	 ...
	 *
	 * For the list of available options please refer to the `$options` parameter of [[\rnd\helpers\Html::activeDropDownList()]].
	 *
	 * If you set a custom `id` for the input element, you may need to adjust the [[$selectors]] accordingly.
	 *
	 * @return $this the field object itself.
	 ...
	 * @param array $options the tag options in terms of name-value pairs.
	 *
	 * For the list of available options please refer to the `$options` parameter of [[\rnd\helpers\Html::activeListBox()]].
	 *
	 * If you set a custom `id` for the input element, you may need to adjust the [[$selectors]] accordingly.
	 *
	 * @return $this the field object itself.
	 ...
	 *
	 * ```php
	 * $form->field($model, 'date')->widget(\rnd\widgets\MaskedInput::className(), [
	 *     'mask' => '99/99/9999',
	 * ]);
	 * ```
	 *
	...
	protected function getClientOptions()
	{
		...
		if ($clientValidation) {
			...
			foreach ($this->model->getActiveValidators($attribute) as $validator) {
				/* @var $validator \rnd\validators\Validator */
