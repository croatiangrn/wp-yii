...
use rnd\base\BaseModel as Model;
use rnd\base\Widget;
 ...
 *
 * Classes extending from this widget can be used in an [[\Rnd\widgets\ActiveForm|ActiveForm]]
 * using the [[\Rnd\widgets\ActiveField::widget()|widget()]] method, for example like this:
 *
 * ```php
...
{
    /**
     * @var \Rnd\widgets\ActiveField active input field, which triggers this widget rendering.
     * This field will be automatically filled up in case widget instance is created via [[\Rnd\widgets\ActiveField::widget()]].
     * @since 2.0.11
     */
    public $field;
    /**
