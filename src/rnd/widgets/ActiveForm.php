...
{
	/**
	 * @var array|string the form action URL. This parameter will be processed by [[\rnd\helpers\Url::to()]].
	 ...
	 * @see fieldConfig
	 */
	public $fieldClass = 'rnd\widgets\ActiveField';
	/**
	 ...
	 * @param BaseModel|BaseModel[] $models the model(s) associated with this form.
	 ...
	 * be HTML-encoded using [[\rnd\helpers\Html::encode()]]. If a value is `null`, the corresponding attribute will not be rendered.
	 ...
	 *
	 * @param BaseModel $model     the data model.
	...
	public function field($model, $attribute, $options = [])
	{
		...
		return Rnd::createObject(ArrayHelper::merge($config, $options, [
			'model' => $model,
			'attribute' => $attribute,
			'form' => $this,
		]));
	 ...
	 * @throws \rnd\base\InvalidConfigException
	 * @throws \rnd\base\NotSupportedException
	 */
