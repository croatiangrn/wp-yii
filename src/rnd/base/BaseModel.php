...
use rnd\validators\RequiredValidator;
use rnd\validators\Validator;
 ...
 *
 * @property \rnd\validators\Validator[] $activeValidators The validators applicable to the current
 ...
 * @property ArrayObject|\rnd\validators\Validator[] $validators All the validators declared in the model.
 * This property is read-only.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @since 2.0
 */
abstract class BaseModel extends Component implements StaticInstanceInterface, IteratorAggregate, ArrayAccess, Arrayable
{
	use ArrayableTrait;
	 ...
	 *
	 * The form name is mainly used by [[\rnd\widgets\ActiveForm]] to determine how to name
	 ...
	 *                                        If this parameter is empty, it means any attribute listed in the
	 *                                        applicable validation rules should be validated.
	 ...
	 * ```
	 *
	 * @return ArrayObject|\rnd\validators\Validator[] all the validators declared in the model.
	 * @throws InvalidConfigException
	 */
	 ...
	 *
	 * @return \rnd\validators\Validator[] the validators applicable to the current [[scenario]].
	 * @throws InvalidConfigException
	 */
	 ...
	 * [[\rnd\validators\RequiredValidator|required]] validation rule in the
	 * current [[scenario]].
	 *
	 * Note that when the validator has a conditional validation applied using
	 * [[\rnd\validators\RequiredValidator::$when|$when]] this method will return
	 ...
	 */
	public function onUnsafeAttribute($name, $value = null)
	{
		if (RND_DEBUG) {
			echo("Failed to set unsafe attribute '$name' in '" . get_class($this) . "'.");
		}
	}
	...
	public function load($data, $formName = null)
	{
		...
		if ($scope === '' && !empty($data)) {
			...
			$data2 = [];
			$data2[$scope] = $data;
			$this->setAttributes( $data2[$scope]);
