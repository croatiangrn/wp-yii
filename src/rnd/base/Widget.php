 ...
 * @property \rnd\web\View $view The view object that can be used to render views or view files. Note that the
...
class Widget extends Component implements ViewContextInterface
{
	 ...
	 * @return \rnd\web\View the view object that can be used to render views or view files.
	 */
