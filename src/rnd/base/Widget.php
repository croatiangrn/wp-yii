 ...
 * @property \rnd\base\View $view The view object that can be used to render views or view files. Note that the
...
class Widget extends Component implements ViewContextInterface
{
	...
	public static function begin($config = [])
	{
		...
		/* @var $widget Widget */
		$widget = Rnd::createObject($config);
		static::$stack[] = $widget;
	 ...
	 * @return \rnd\base\View the view object that can be used to render views or view files.
	 */
