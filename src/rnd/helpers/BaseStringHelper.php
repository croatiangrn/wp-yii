...
class BaseStringHelper
{
	...
	public static function truncate($string, $length, $suffix = '...', $encoding = null, $asHtml = false) {
		if ($asHtml) {
			return static::truncateHtml($string, $length, $suffix, $encoding ?: Rnd::$app->charset);
		}
		if (mb_strlen($string, $encoding ?: Rnd::$app->charset) > $length) {
			return rtrim(mb_substr($string, 0, $length, $encoding ?: Rnd::$app->charset)) . $suffix;
		} else {
			return $string;
		}
	}
	...
	public static function startsWith($string, $with, $caseSensitive = true)
	{
		...
		if ($caseSensitive) {
			...
			return mb_strtolower(mb_substr($string, 0, $bytes, '8bit'), Rnd::$app->charset) === mb_strtolower($with, Rnd::$app->charset);
		}
	}
	...
	public static function endsWith($string, $with, $caseSensitive = true)
	{
		...
		if ($caseSensitive) {
			...
			return mb_strtolower(mb_substr($string, -$bytes, mb_strlen($string, '8bit'), '8bit'), Rnd::$app->charset) === mb_strtolower($with, Rnd::$app->charset);
		}
	}
