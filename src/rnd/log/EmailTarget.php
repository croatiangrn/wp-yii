...
{
    /**
     * @var array the configuration array for creating a [[\rnd\mail\MessageInterface|message]] object.
    ...
    public function init()
    {
        ...
        $this->mailer = Instance::ensure($this->mailer, 'rnd\mail\MailerInterface');
    }
     ...
     * @return \rnd\mail\MessageInterface $message
     */
    protected function composeMessage($body)
    {
        $message = $this->mailer->compose();
        Rnd::configure($message, $this->message);
