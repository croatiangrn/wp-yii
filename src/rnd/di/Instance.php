...
class Instance
{
	 ...
	 *
	 * If you do not specify a container, the method will first try `Rnd::$app` followed by `Rnd::$container`.
	 *
	 * For example,
	 *
	 * ```php
	 ...
	 * If null, the method will first try `Rnd::$app` then `Rnd::$container`.
	...
	public function get($container = null)
	{
		...
		if (Rnd::$app && Rnd::$app->has($this->id)) {
			return Rnd::$app->get($this->id);
		} else {
			return Rnd::$container->get($this->id);
		}
	}
