<?php
/**
 * @link http://www.RNDframework.com/
 * @copyright Copyright (c) 2008 RND Software LLC
 * @license http://www.RNDframework.com/license/
 */

use rnd\requirements\RndRequirementsChecker;

/* @var $this RndRequirementsChecker */

/**
 * These are the RND core requirements for the [[RNDRequirementChecker]] instance.
 * These requirements are mandatory for any RND application.
 */
return [
	[
		'name' => 'PHP version',
		...
		'by' => '<a href="http://www.RNDframework.com">RND Framework</a>',
	...
	[
		...
		'by' => '<a href="http://www.RNDframework.com/doc-2.0/RND-base-security.html">Security Component</a>',
	...
	[
        ...
        in <code>RND::t()</code>, non-latin languages with <code>Inflector::slug()</code>,
        <abbr title="Internationalized domain names">IDN</abbr>-feature of
        <code>EmailValidator</code> or <code>UrlValidator</code> or the <code>rnd\i18n\Formatter</code> class.'
	],
	[
		'name' => 'ICU version',
		'mandatory' => false,
        ...
        <a href=\"http://www.RNDframework.com/doc-2.0/RND-i18n-formatter.html#asRelativeTime%28%29-detail\">
        Formatter::asRelativeTime()</a>) in the <code>rnd\i18n\Formatter</code> class. Your current ICU version is ' .
	...
	[
        ...
        (for example, plural in
        <a href=\"http://www.RNDframework.com/doc-2.0/RND-i18n-formatter.html#asRelativeTime%28%29-detail\">
        Formatter::asRelativeTime()</a>) in the <code>rnd\i18n\Formatter</code> class. Your current ICU Data version is ' .
	...
	[
		...
		'memo' => 'Required for REST API to send XML responses via <code>rnd\web\XmlResponseFormatter</code>.'
	],
	[
		'name' => 'IPv6 support',
		'mandatory' => false,
		'condition' => defined('AF_INET6'),
		'by' => 'IPv6 expansion in <a href="http://www.RNDframework.com/doc-2.0/RND-validators-ipvalidator.html">IpValidator</a>',
		'memo' => 'When <a href="http://www.RNDframework.com/doc-2.0/RND-validators-ipvalidator.html#$expandIPv6-detail">IpValidator::expandIPv6</a>
