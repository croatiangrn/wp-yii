<?php
/* @var $this \rnd\requirements\RndRequirementsChecker */
/* @var $summary array */
...
<head>
	<meta charset="utf-8"/>
	<title>RND Application Requirement Checker</title>
	<?php $this->renderViewFile(dirname(__FILE__) . '/css.php'); ?>
</head>
<body>
<div class="container">
	<header>
		<h1>RND Application Requirement Checker</h1>
	</header>
	<hr>
	<main>
		<h3>Description</h3>
		...
		<p>
			...
			to allow RND to work as expected. There are also some optional requirements being checked which will
			show you a warning when they do not meet. You can use RND framework without them but some specific
